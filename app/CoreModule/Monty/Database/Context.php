...
class Context
{
	...
	public function __construct(
		...
		Nette\Database\Structure $structure,
		Nette\Database\Conventions $conventions = null,
	...
	{
		return new \Monty\Database\Table\Selection($this, $this->conventions, $table, $this->cacheStorage);
	}
