...
class ImageNew {
	...
	public static function fromFile(string $file, int &$detectedFormat = null)
	{
		...
		$image = new static(Callback::invokeSafe('imagecreatefrom' . image_type_to_extension($detectedFormat, false), [$file], function (string $message): void {
	...
	public function save($name = null, $quality = 100, $type = null) {
		...
		\Tracy\Debugger::barDump(self::$image, "this image");
